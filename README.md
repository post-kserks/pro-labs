...
- при наличии Docker строит образы `vaultdb/vaultdb:1.0.2` и `latest`
...
```bash
docker build -t vaultdb/vaultdb:1.0.2 .
docker run -p 5432:5432 -p 8080:8080 vaultdb/vaultdb:1.0.2
```
